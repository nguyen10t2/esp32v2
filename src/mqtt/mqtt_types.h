...
extern "C"
{
#endif
    /**
     * @brief Trạng thái đồng bộ thời gian, được sử dụng để đánh giá xem node cảm biến đã đồng bộ thời gian với máy chủ MQTT hay chưa.
     */
    typedef enum {
    ...
    /**
     * @brief Cấu trúc dữ liệu chứa thông tin cảm biến và trạng thái của node, được sử dụng làm payload trong MQTT.
     */
    typedef struct
    {
